...
class CriticalPatientWidget extends StatelessWidget {
  const CriticalPatientWidget({
    Key? key,
    required Future<List> futureCriticalData,
  }) : _futureCriticalData = futureCriticalData, super(key: key);

  final Future<List> _futureCriticalData;
